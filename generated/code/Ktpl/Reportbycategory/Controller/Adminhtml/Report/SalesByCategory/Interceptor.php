<?php
namespace Ktpl\Reportbycategory\Controller\Adminhtml\Report\SalesByCategory;

/**
 * Interceptor class for @see \Ktpl\Reportbycategory\Controller\Adminhtml\Report\SalesByCategory
 */
class Interceptor extends \Ktpl\Reportbycategory\Controller\Adminhtml\Report\SalesByCategory implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function _initReportAction($blocks)
    {
        ...
        if (!$pluginInfo) {
            return parent::_initReportAction($blocks);
        } else {
